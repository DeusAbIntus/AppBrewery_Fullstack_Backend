...
app.post("/submit", (req, res) => {
  ...
  //scroll down to see the two arrays.
   var randomizerAdj = Math.floor (Math.random() * adj.length);
   var randomizerNoun = Math.floor (Math.random() * noun.length);
   var randomAdj = adj[randomizerAdj];
   var randomNoun = noun [randomizerNoun];
   var randomBandName = randomAdj + " " + randomNoun;
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
    res.render ("index.ejs", { 
      bandName : randomBandName,
      year: currentYear 
    });
